...
def upgrade() -> None:
    ...
    tags_type = postgresql.JSONB(astext_type=sa.Text()) if op.get_bind().dialect.name == "postgresql" else sa.JSON()
    op.add_column("projects", sa.Column("tags", tags_type, nullable=True))
