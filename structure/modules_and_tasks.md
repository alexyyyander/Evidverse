# Evidverse 任务分解与优先级规划

基于 `plan/evidverse_development_roadmap.md` 和 `plan/evidverse_seedance_implementation.md` 的分析，我们将当前阶段（Phase 0: 技术验证）的开发任务分解为以下核心模块。
...
| 任务ID | 任务名称 | 优先级 | 描述 |
|:---:|:---|:---:|:---|
| CLI-01 | **CLI 工具开发 (evidverse)** | **P1** | 开发命令行工具，支持 `init`, `generate`, `log`, `branch` 等操作。 |
...
| 任务ID | 任务名称 | 优先级 | 描述 |
|:---:|:---|:---:|:---|
| FE-03 | **Web 项目导入器** | **P1** | 支持通过 URL/ID 导入公开的 Evidverse 项目，解析元数据和版本树，实现“一键Fork别人项目”。 |
