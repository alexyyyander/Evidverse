  ...
  return (
    <div className="h-full flex flex-col">
      <Dialog
        ...
        title="删除人物"
        description="删除后会从 Beat 引用中移除该人物。"
        footer={
      ...
      >
        <div className="text-sm text-muted-foreground">该操作可通过 Undo 撤销。</div>
      </Dialog>
      ...
      <Dialog
        ...
        title="合并人物"
        description="把来源人物的引用合并到目标人物，并删除来源人物。"
        footer={
          <div className="flex justify-end gap-2">
      ...
      >
        <div className="space-y-3">
          <div className="text-sm text-muted-foreground">选择目标人物：</div>
          <select
