...
本文目标：用一份文档把 Vidgit 仓库的模块边界、关键入口与常见改动落点讲清楚，方便快速上手与协作开发。

## 1. 仓库定位

Vidgit 是一个 Monorepo，核心能力是「AI 视频生成 + Web 可视化编辑器 + 类 Git 版本控制（commit/branch/fork/merge）+ 社区/发布」，整体由以下组件构成：
...
更宏观的数据流与接口说明可参考：
- [architecture.md](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/docs/architecture.md)
- [developer_guide.md](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/docs/developer_guide.md)
...
- FastAPI 入口：[main.py](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/backend/app/main.py)
- API 路由总入口：[router.py](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/backend/app/api/v1/router.py)
- API 前缀：`/api/v1`
...
- Celery app 初始化：[celery_app.py](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/backend/app/core/celery_app.py)
...
- axios client + token 注入与错误归一化：[client.ts](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/frontend/src/lib/api/client.ts)
- 领域 API 聚合导出：[index.ts](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/frontend/src/lib/api/index.ts)
- 领域 API 实现：`frontend/src/lib/api/domains/*`
  - 示例（云端项目域）：[cloud_projects.ts](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/frontend/src/lib/api/domains/cloud_projects.ts)
  - 云端 client（可选启用）：[cloudClient.ts](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/frontend/src/lib/api/cloudClient.ts)
...
- 依赖清单：[ai_engine/requirements.txt](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/ai_engine/requirements.txt)

## 6. CLI（cli）结构与入口

CLI 用于把核心能力以命令行形式暴露给 power user / 自动化：

- CLI 入口：`cli/vidgit/main.py`
- API 访问封装：`cli/vidgit/api.py`
- 配置与上下文：`cli/vidgit/config.py`、`cli/vidgit/context.py`
...
- [docker-compose.yml](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/docker-compose.yml)：db/redis/rabbitmq/minio + createbuckets
...
- Nginx 反代配置：[default.conf](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/nginx/conf.d/default.conf)
  - `/` → frontend
...
- 说明：[infrastructure/cloud/README.md](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/infrastructure/cloud/README.md)

## 8. Plan & 文档（“单一真相源”）

开发流程与当前阶段以此为准：
- [current_stage&FAQ.md](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/plan/current_stage&FAQ.md)
...
- 新增/修改后端 API：
  ...
  - 别忘了在 [router.py](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/backend/app/api/v1/router.py) 注册路由
- 新增前端 API 调用：
...
快速启动与排障指南：
- [README.md](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/README.md)
- [developer_guide.md](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/docs/developer_guide.md)

测试脚本入口：
- 后端：`./backend/tests/run_tests.sh`（见 [run_tests.sh](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/backend/tests/run_tests.sh)）
- 前端：`./frontend/tests/run_tests.sh`（见 [run_tests.sh](file:///mnt/c/Users/dubdoo/Desktop/individual_project/vidgit/frontend/tests/run_tests.sh)）
