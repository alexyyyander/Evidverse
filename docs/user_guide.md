...
- **Project Detail Page**: A hub for your project showing description, stats, and history.
...
- **Merge Requests**: (For owners) Review and merge changes from other branches.
